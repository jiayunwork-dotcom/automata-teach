...
import { automatonToRegularGrammar, regularGrammarToAutomaton } from '../../engine/grammar/conversion';
import { isRegularGrammar, parseGrammar } from '../../engine/grammar/parser';
